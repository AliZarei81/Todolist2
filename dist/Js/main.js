...
const checkItem = (itemId) => {
    ...
    const text = itemElement.querySelector(`#text-${itemId}`);
    const btn = itemElement.querySelector(`#check-${itemId}`);
    const priority = itemElement.querySelector(`#item-priority-${itemId}`);
    const toolTip = itemElement.querySelector(`#checked-${itemId}`);
...
const setEditEvents = (itemId) => {
    ...
    const cancelBtn = document.querySelector("#edit-no");
    const changePriorityBtn = document.querySelector("#edit-priority");
    const confirmBtn = document.querySelector("#edit-yes");
    const newText = document.querySelector(`#edit-input-${itemId}`);
